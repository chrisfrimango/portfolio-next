...
export default function ProjectsSection() {
  ...
  return (
    <div className="w-full mx-auto max-w-content px-5 sm:px-8 lg:px-12 py-12 space-y-16">
      {/* 01 / 02 — flagship */}
      <article className="lg:grid lg:grid-cols-12 lg:gap-x-6">
        ...
        <div className="mt-6 lg:mt-0 lg:col-start-9 lg:col-span-4 lg:self-end">
          <p className="font-display italic text-statement text-brand-accent">
            01 / 02
          </p>
          <h3 className="font-display text-title text-brand-ink mt-2">
            {flagship.title}
          </h3>
          <p className="text-body text-brand-gray max-w-[42ch] mt-4">
            {flagship.shortDescription}
          </p>
          <p className="text-meta font-medium uppercase text-brand-gray mt-6">
      ...
      {/* 02 / 02 — this site */}
      <article className="border-t border-brand-ink/10 pt-10 lg:grid lg:grid-cols-12 lg:gap-x-6">
